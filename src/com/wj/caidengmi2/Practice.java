...
public class Practice extends Activity implements View.OnClickListener, UpdateScordNotifier {
	...
	private void playGame() {
		//this.mPdg = ProgressDialog.show(this, "", getText(R.string.Practice));
		mgetAnswerBtn.setEnabled(true);
		Practice.this.genRiddles();
		Practice.this.mHandler.sendEmptyMessage(0);
	}
	...
	public void onClick(View view) {
		 	//查詢用戶積分
			ScoreWallSDK.getInstance(Practice.this,Practice.this).getScore();
			...
			if(mStartBtn == view){
				...
				if(pointTotal<2){
		            //规定弹窗的位置
		            popWindow.showAtLocation(findViewById(R.id.main1), Gravity.BOTTOM,0, 0);
	...
	public void onCreate(Bundle paramBundle) {
		...
		startService(intent);
		LayoutInflater layoutInflater = (LayoutInflater) (Practice.this).getSystemService(LAYOUT_INFLATER_SERVICE);
		...
		textView1.setText("当前余额："+pointTotal);
		this.mgetAnswerBtn.setEnabled(false);
		genNormHighestScore();
		closeMusic();
	...
	class MyHandler extends Handler {
		...
		public void handleMessage(Message paramMessage) {
			...
			//Practice.this.mPdg.dismiss();
			Practice.this.mStartBtn.setImageResource(R.drawable.bt_next_task);
			Practice.this.mStatus = 1;
			Practice.this.nextRiddle();
		}
	}
	...
	class MyHandler2 extends Handler {
		public void handleMessage(Message paramMessage) {
			super.handleMessage(paramMessage);
			textView1.setText("当前余额："+Practice.this.pointTotal);
		}
	}
